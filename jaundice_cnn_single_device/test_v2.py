...
if __name__ == '__main__':
    ...
    pretrain_path = f'./samsung_s20_dng_TB2_rgb.pth'
    ...
    img_base_dir     = f'/home/ngroup/NTUH-Jiawei/detect_FM/output'
    ...
    print("accuracy, BA, recall, specificity, PPV, NPV, f1, auroc, auprc")
    for val in score[1:]:
        print(f'{val:.3f}', end='  ')
    print()
