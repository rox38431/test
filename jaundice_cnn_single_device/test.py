...
if __name__ == '__main__':
    ...
    for camera in ['samsung_s20', 'iphone_11', 'cat_s62']:
        ...
        for thr in [3, 2, 1.2]:
            ...
            # ============================
            # Predict Valid Without Train
            # ============================
            
            score_list = []
            for f_idx in [0, 1, 2, 3, 4]:
                test_PD       = dataset_dict['f5_valid_PD'][f_idx]
                pretrain_path = f'./result/ckpt/vgg16_bn_cls/valid/{camera}_{img_type}_TB{thr}_{space}_{f_idx}.pth'
            ...
            # print('train', end=' ')
            if (len(score_list) != 0):
                for val in np.mean(score_list, axis=0):
                    print(f'{val:.3f}', end='  ')
            print()
